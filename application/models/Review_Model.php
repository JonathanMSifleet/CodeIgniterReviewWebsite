...
class Review_Model extends CI_Model {
	...
	public function getComments() {
		...
		$query = $this->db->query("SELECT UID, UserComment, TimeStamp, UserName, admin FROM gamescomments INNER JOIN users USING (UserID) WHERE ReviewID = {$_SESSION['reviewID']} ORDER BY TimeStamp DESC;");
		return $query->result();
